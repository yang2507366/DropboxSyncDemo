...
- (BOOL)application:(UIApplication *)application openURL:(NSURL *)url sourceApplication:(NSString *)sourceApplication annotation:(id)annotation
{
	...
	if (account) {
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:@"kDropboxDidAuthorizedNotification" object:filesystem];
        NSArray *arr = [filesystem listFolder:[DBPath root] error:nil];
        NSLog(@"%@", arr);
	}
    return YES;
}
